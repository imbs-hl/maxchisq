...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(chisq_statistic(observed_left, observed_right, k, n));
    return __result;
END_RCPP
}
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(pmaxchisq_permutation_internal(b, k, n, num_permutations, y, num_left, class_counts));
    return __result;
END_RCPP
}
